...
const securityHeaders = [
  ...
  },
  {
    ...
    value: [
      ...
      "connect-src 'self' https://*.supabase.co https://api.open-meteo.com https://archive-api.open-meteo.com https://overpass-api.de https://api.inaturalist.org https://nominatim.openstreetmap.org https://checkout.bepaid.by https://www.google-analytics.com https://www.googletagmanager.com https://mc.yandex.ru wss://mc.yandex.ru",
      "media-src 'self'",
