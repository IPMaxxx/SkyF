...
const FAQ_ITEMS = [
  ...
  {
    q: "Что такое «мицелий на зерне» и почему это важно?",
    a: "Многие производители выращивают мицелий на рисе или овсе. В результате порошок содержит 40–60% крахмала от субстрата и минимум активных веществ гриба. Такие добавки не эквивалентны мицелию из клинических исследований, где использовалась жидкая ферментация с контролируемым содержанием эринацина А. При покупке проверяйте сертификат анализа: бета-глюканы > 20%, альфа-глюканы (крахмал) < 10%.",
  },
  {
