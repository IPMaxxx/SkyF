...
const FAQ_ITEMS = [
  {
    ...
    a: "Ежовик содержит уникальные вещества — эринацины (в мицелии) и герициноны (в плодовом теле), которые стимулируют выработку фактора роста нервов (NGF). Клинические исследования на людях показали улучшение когнитивных функций, снижение тревоги и депрессии при регулярном приёме.",
  },
  {
    q: "Что лучше — мицелий или плодовое тело ежовика?",
    a: "Для когнитивных функций — мицелий. Именно в мицелии содержатся эринацины, которые стимулируют NGF и проникают через гематоэнцефалический барьер. Герициноны из плодовых тел тоже полезны — они работают на иммунитет и имеют противоопухолевую активность — но на мозг влияют слабее.",
  },
  {
  ...
  },
  {
    ...
    a: "В клинических исследованиях эффекты наблюдались при приёме от 750 мг до 3000 мг в день на протяжении 4–8 недель. Улучшение когнитивных функций нарастало с каждой неделей, но могло снижаться после прекращения приёма.",
  },
  {
    q: "Есть ли побочные эффекты у ежовика гребенчатого?",
    a: "В проведённых клинических испытаниях серьёзных побочных эффектов не зафиксировано. Ежовик считается безопасным продуктом питания. Однако перед применением в качестве добавки рекомендуется консультация с врачом, особенно при приёме медикаментов.",
  },
];
    ...
    <>
      ...
      <article className="mx-auto max-w-3xl px-4 py-16 sm:py-24">
        ...
        <p className="mb-8 text-sm text-white/40">
          Обновлено: 1 октября 2025 · 15 мин чтения
        </p>
        ...
        <p className="mb-5 leading-relaxed text-white/80">
          ...
          <a
            href="https://pmc.ncbi.nlm.nih.gov/articles/PMC5987239/"
            target="_blank"
            rel="noopener noreferrer"
            className="text-emerald-400 underline decoration-emerald-400/30 hover:text-emerald-300"
          >
            Исследование, опубликованное в журнале Behavioural Neurology
            (PMC5987239)
          </a>
          , показало: в плодовых телах ежовика эринацины практически не
          обнаруживаются. Мицелий — единственный значимый источник этих
          соединений.
        </p>
        <p className="mb-5 leading-relaxed text-white/80">
          ...
          активностью. Но — и это принципиально — они{" "}
          <strong className="text-white">
            не оказывают значимого влияния на когнитивные функции
          </strong>
          , в отличие от эринацинов из мицелия.
        </p>
        <p className="mb-5 leading-relaxed text-white/80">
        ...
        <p className="mb-5 leading-relaxed text-white/80">
          Наука в этом споре занимает чёткую позицию. Эринацины — единственные
          вещества ежовика, для которых{" "}
          <strong className="text-white">
            клинически доказано влияние на когнитивные функции, депрессию и
            нейрорегенерацию
          </strong>
          ...
          <a
            ...
            className="text-emerald-400 underline decoration-emerald-400/30 hover:text-emerald-300"
          >
            аналитическим исследованием (PMC5987239)
          </a>
          .
        </p>
        <p className="mb-5 leading-relaxed text-white/80">
        ...
        <ul className="mb-5 list-inside space-y-2 text-white/80">
          <li className="leading-relaxed">
            ...
            содержания эринацинов (erinacine A, C).
          </li>
          <li className="leading-relaxed">
          ...
          <li className="leading-relaxed">
            <strong className="text-white">Производитель:</strong> отдавайте
            предпочтение брендам, которые указывают стандартизацию по
            эринацинам и предоставляют сертификаты анализов.
          </li>
        </ul>
        ...
        <p className="mb-5 leading-relaxed text-white/80">
          ...
          зафиксировано в рецензированных научных журналах с десятками и сотнями
          участников.
        </p>
        <p className="mb-8 leading-relaxed text-white/80">
          ...
          . Плодовые тела хороши для иммунитета, но не для мозга. И помните —
          эффект накопительный: минимум 4 недели регулярного приёма, а при
