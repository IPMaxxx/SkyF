        ...
        <div id="best-days" className="mt-10 scroll-mt-20">
          <div className="mb-4">
            ...
            <p className="mt-1 text-xs text-muted-foreground">
              Грибной день — это связка локации, даты удачного сбора и погодного «отпечатка» за 14 дней. Используется как эталон: система сравнивает текущую погоду с этими данными и оповещает, когда условия повторяются. Грибные дни также можно продавать на маркетплейсе.
            </p>
          </div>
