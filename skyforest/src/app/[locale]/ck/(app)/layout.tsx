...
/**
 * Оболочка экранов приложения Mushroom Checker (распознавание, история,
 * квесты, аккаунт, подписка): нижнее меню и место под него.
 *
...
export default function CheckerAppLayout({
  ...
  return (
    <div
      ...
      style={
        {
          "--ck-tabbar": "calc(62px + env(safe-area-inset-bottom))",
