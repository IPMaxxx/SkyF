 ...
 * Размеры кнопок (58/56/52/50) из дизайна: их жмут в походе и в перчатках,
...
/** «Я вернулся из похода» — заметная, но не кричащая. */
 ...
 * этого карта похода перекрывала подтверждение завершения похода.
 */
