...
interface Props {
  anchor: TrackPoint;
  points: TrackPoint[];
  /** Текущая позиция; t — время замера (для честного пунктира после разрыва). */
...
/**
 * Разрыв между соседними точками больше этого времени означает, что точки не
 * собирались: в SkyForest — потому что приложение было в фоне, в WayBack — не
 * было спутников (там запись идёт и в фоне). Такой сегмент рисуем пунктиром,
  ...
  return (
    <div className="relative overflow-hidden rounded-xl border border-border">
      ...
      >
        ...
        {/* Разрывы (точки не собирались, см. GAP_MS): полупрозрачный пунктир */}
