...
export default {
  ...
  quests: {
    title: "Квесты",
    subtitle:
      "Сфотографируйте и определите 15 видов. Квест закрывается, когда вид оказался первым в результате распознавания.",
    overall: "ОБЩИЙ ПРОГРЕСС",
    overallCount: "{found} из {total}",
    safetyTitle: "Никогда не ешьте гриб, опираясь на результат.",
    safetyBody:
      "Квесты — про фотографию и определение, а не про сбор в корзину. Нажмите на вид, чтобы прочитать о нём и его опасных двойниках.",
    levelBadge: "УРОВЕНЬ {n}",
    levelDone: "Уровень пройден · {date}",
    foundLabel: "Определён {date}",
    foundOn: "{name} — определён {date}. Открыть справку о виде",
    notFoundHint: "{name} — ещё не определён. Открыть справку о виде",
