...
export default {
  ...
  mapLayerOutdoor: "Trails (offline)",

  offlineMapTitle: "Offline map",
  offlineMapDesc:
    "Download the map for this area while you have signal — it will keep working in the forest without internet.",
  offlineMapUseLocation: "Use my location",
  offlineMapGettingLocation: "Getting your location…",
  offlineMapRadius: "Area radius",
  offlineMapKm: "km",
  offlineMapMinimalQuality: "minimal quality (overview)",
  offlineMapQuality: "Detail level",
  offlineMapQualityBase: "Basic",
  offlineMapQualityMedium: "Medium",
  offlineMapQualityMax: "Maximum",
  ...
  offlineMapDownload: "Download this area",
  offlineMapDownloading: "Downloading… {done}/{total}",
  offlineMapCancel: "Cancel",
  offlineMapSavedToast: "Area saved for offline use",
  offlineMapPartialToast: "Saved with {failed} tiles skipped (network)",
  offlineMapErrorToast: "Could not download the area. Please try again.",
  offlineMapStoredTitle: "Downloaded areas",
  offlineMapEmpty: "No offline areas yet.",
  offlineMapRegionMeta: "{tiles} tiles · {size}",
  offlineMapDelete: "Delete",
  offlineMapDeletedToast: "Offline area deleted",
