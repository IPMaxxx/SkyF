...
export default {
  ...
  tableDate: "Date",
  tooltipTempMean:
    "Mean air temperature at 2 m ({u}). Key for mushroom growth. Optimal: {opt}.",
  tempMeanShort: "t avg {u}",
  tooltipTempMin:
    "Minimum air temperature ({u}). Important for night frosts that can stop mycelium growth.",
  tempMin: "t min {u}",
  tooltipTempMax:
    "Maximum air temperature ({u}). Very high (>{hot}) slows mushroom growth.",
  tempMax: "t max {u}",
  tooltipRain:
    "Liquid precipitation (rain) in {u} per day. Rain in the 7–14 days before picking is the main factor for flushes.",
  rain: "Rain",
  tooltipWind:
    "Maximum wind speed at 10 m ({u}). Strong wind (>{strong}) dries soil and worsens conditions.",
  wind: "Wind",
  ...
  legendStats:
    "{pts} pts · {min}–{max} {unit} · avg {avg} {unit}",
  savedMaps: "Saved maps",
  savedMapParams: "R:{radius} · S:{step} · {days}d",
  myLocations: "My locations",
  myLocationsNoneHint: "No saved locations to show",
  myLocationOutOfArea: "Outside the generated rain map area",
  myLocationNearest: "{unit} to nearest rain point",
  unitMm: "mm",
  unitKmH: "km/h",
  rainPopupToday: "today",
  rainPopupDaysAgo: "{n, plural, one {# day ago} other {# days ago}}",
  rainPopupTempMean: "Mean t°: {v}{u}",
  rainPopupMax: "Max",
  rainPopupMin: "Min",
  rainPopupMaxRain: "Max rain",
  rainPopupCenter: "Center",
  rainPopupRadius: "Radius: {radius} {unit}, step: {step} {unit}",
