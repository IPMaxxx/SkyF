...
export default {
  ...
  geoErrorPick:
    "Не удалось определить местоположение. Поставьте точку входа на карте вручную.",
  pickOnMap: "Указать точку входа на карте",
  pickOnMapHint: "Коснитесь карты, чтобы поставить точку входа.",
  pickConfirm: "Я вошёл здесь",
  pickCancel: "Отмена",
  ...
  offlineMapQuality: "Глубина детализации",
  offlineMapQualityBase: "Базовая",
  offlineMapQualityMedium: "Средняя",
  offlineMapQualityMax: "Максимальная",
  ...
  historyEmpty: "Походов пока нет",
  historyEmptyHint:
    "Отметьте точку входа перед тем, как зайти в лес, — после завершения поход появится здесь с расстоянием и длительностью.",
} as const;
