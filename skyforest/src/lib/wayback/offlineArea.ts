...
/** Глубже 16 в этом стиле карты новых деталей леса не появляется. */
 ...
 * уже лежащие в хранилище тайлы пропускаются (повторный проход по знакомому
 * лесу не стоит трафика), а при отмене запись об области всё равно сохраняется
