 ...
 * ждать было нечего.
 *
 * Проверяем на подделке, ведущей себя ровно как прокси Capacitor. Здесь —
 * только правило; все загрузчики плагинов проекта по этому правилу проходит
 * fastlane/.plugin-proxy-check.mjs, там же весь src просматривается на новые
